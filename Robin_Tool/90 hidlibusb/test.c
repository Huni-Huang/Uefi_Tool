...
#include <string.h>
#include <stdlib.h>
#include <linux/hiddev.h>  //robin add 20210507
#include <linux/hid.h>
...
int main(int argc, char* argv[])
{
	...
	unsigned char yie_buf[17];  //robin: buffer to yie002
	...
	handle = hid_open(0x8765, 0x4321, NULL);
	if (!handle) {
...
//------------------------ Feature Report  ------------------------
	// printf("---------Access my device with Feature Report, Press Enter key to continue....\n");
	// getchar();
...
//------------------Output Report & Input Report--------------------
	// printf("---------Access my device with Output  & Input Report, Press Enter key to continue....\n");
	// getchar();
	memset(yie_buf,0,sizeof(yie_buf));
	yie_buf[0] = 0x00;
	yie_buf[1] = 0xA0;
	...
	// res = hidSetOutReport(handle,yie_buf, 1);
	// if (res < 0) {
	// 	printf("Unable to hidSetOutReport()\n");
	// 	printf("Error: %ls\n", hid_error(handle));
	// }
//--------------------Read & Write----------------------
	// printf("---------Access my device with Read & Write, Press Enter key to continue....\n");
	// getchar();
	memset(yie_buf,0,sizeof(yie_buf));
	yie_buf[0] = 0x00;
	yie_buf[1] = 0xA0;
