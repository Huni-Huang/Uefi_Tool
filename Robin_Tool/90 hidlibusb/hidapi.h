...
extern "C" {
		...
		*/
		...
		/** @brief Get a input report from a HID device.
			...
			@returns
				...
				byte), or -1 on error.
		*/
		int HID_API_EXPORT HID_API_CALL  hid_set_output_report(hid_device *dev, const unsigned char *data, size_t length); //robin add
		...
		*/
		...
		// int hidSetOutReport(hid_device *dev,unsigned char * data, int len);
		// int hidGetInReport(hid_device *dev, unsigned char * data, int len);
